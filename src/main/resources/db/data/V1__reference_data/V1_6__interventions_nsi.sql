...
select (SELECT MAX(STANDARD_REFERENCE_LIST_ID) + 1 FROM R_STANDARD_REFERENCE_LIST), 'CRS01', 'Cancelled', 'Y', (SELECT USER_ID FROM USER_ WHERE DISTINGUISHED_NAME = 'DELIUS_SYSTEM_USER'), sysdate, (SELECT USER_ID FROM USER_ WHERE DISTINGUISHED_NAME = 'DELIUS_SYSTEM_USER'), sysdate,
...
select * from R_NSI_TYPE_OUTCOME;
select STANDARD_REFERENCE_LIST_ID from R_STANDARD_REFERENCE_LIST where REFERENCE_DATA_MASTER_ID in (
    select REFERENCE_DATA_MASTER_ID from R_REFERENCE_DATA_MASTER where CODE_SET_NAME = 'NSI OUTCOME')
                                                                   and CODE_VALUE = 'END';
...
where nt.CODE = 'CRS01' and noi.CODE_VALUE = 'COMP' and rdm.CODE_SET_NAME = 'NSI OUTCOME'
  and NOT EXISTS
...
select nt.NSI_TYPE_ID, noi.STANDARD_REFERENCE_LIST_ID
from R_NSI_TYPE nt, R_STANDARD_REFERENCE_LIST noi join R_REFERENCE_DATA_MASTER rdm on rdm.REFERENCE_DATA_MASTER_ID = noi.REFERENCE_DATA_MASTER_ID
where nt.CODE = 'CRS01' and noi.CODE_VALUE = 'END' and rdm.CODE_SET_NAME = 'NSI OUTCOME'
  and NOT EXISTS
    (select * from R_NSI_TYPE_OUTCOME n where n.NSI_TYPE_ID = nt.NSI_TYPE_ID and n.NSI_OUTCOME_ID = noi.STANDARD_REFERENCE_LIST_ID)
;
...
select nt.NSI_TYPE_ID, noi.STANDARD_REFERENCE_LIST_ID
from R_NSI_TYPE nt, R_STANDARD_REFERENCE_LIST noi join R_REFERENCE_DATA_MASTER rdm on rdm.REFERENCE_DATA_MASTER_ID = noi.REFERENCE_DATA_MASTER_ID
where nt.CODE = 'CRS02' and noi.CODE_VALUE = 'COMP' and rdm.CODE_SET_NAME = 'NSI OUTCOME'
  and NOT EXISTS
    (select * from R_NSI_TYPE_OUTCOME n where n.NSI_TYPE_ID = nt.NSI_TYPE_ID and n.NSI_OUTCOME_ID = noi.STANDARD_REFERENCE_LIST_ID)
;
insert into R_NSI_TYPE_OUTCOME(NSI_TYPE_ID, NSI_OUTCOME_ID)
...
select nt.NSI_TYPE_ID, noi.STANDARD_REFERENCE_LIST_ID
from R_NSI_TYPE nt, R_STANDARD_REFERENCE_LIST noi join R_REFERENCE_DATA_MASTER rdm on rdm.REFERENCE_DATA_MASTER_ID = noi.REFERENCE_DATA_MASTER_ID
where nt.CODE = 'CRS02' and noi.CODE_VALUE = 'END' and rdm.CODE_SET_NAME = 'NSI OUTCOME'
  and NOT EXISTS
    (select * from R_NSI_TYPE_OUTCOME n where n.NSI_TYPE_ID = nt.NSI_TYPE_ID and n.NSI_OUTCOME_ID = noi.STANDARD_REFERENCE_LIST_ID)
;
...
select nt.NSI_TYPE_ID, noi.STANDARD_REFERENCE_LIST_ID
from R_NSI_TYPE nt, R_STANDARD_REFERENCE_LIST noi join R_REFERENCE_DATA_MASTER rdm on rdm.REFERENCE_DATA_MASTER_ID = noi.REFERENCE_DATA_MASTER_ID
where nt.CODE = 'CRS03' and noi.CODE_VALUE = 'COMP' and rdm.CODE_SET_NAME = 'NSI OUTCOME'
  and NOT EXISTS
    (select * from R_NSI_TYPE_OUTCOME n where n.NSI_TYPE_ID = nt.NSI_TYPE_ID and n.NSI_OUTCOME_ID = noi.STANDARD_REFERENCE_LIST_ID)
;
insert into R_NSI_TYPE_OUTCOME(NSI_TYPE_ID, NSI_OUTCOME_ID)
...
select nt.NSI_TYPE_ID, noi.STANDARD_REFERENCE_LIST_ID
from R_NSI_TYPE nt, R_STANDARD_REFERENCE_LIST noi join R_REFERENCE_DATA_MASTER rdm on rdm.REFERENCE_DATA_MASTER_ID = noi.REFERENCE_DATA_MASTER_ID
where nt.CODE = 'CRS03' and noi.CODE_VALUE = 'END' and rdm.CODE_SET_NAME = 'NSI OUTCOME'
  and NOT EXISTS
    (select * from R_NSI_TYPE_OUTCOME n where n.NSI_TYPE_ID = nt.NSI_TYPE_ID and n.NSI_OUTCOME_ID = noi.STANDARD_REFERENCE_LIST_ID)
;
...
select nt.NSI_TYPE_ID, noi.STANDARD_REFERENCE_LIST_ID
from R_NSI_TYPE nt, R_STANDARD_REFERENCE_LIST noi join R_REFERENCE_DATA_MASTER rdm on rdm.REFERENCE_DATA_MASTER_ID = noi.REFERENCE_DATA_MASTER_ID
where nt.CODE = 'CRS04' and noi.CODE_VALUE = 'COMP' and rdm.CODE_SET_NAME = 'NSI OUTCOME'
  and NOT EXISTS
    (select * from R_NSI_TYPE_OUTCOME n where n.NSI_TYPE_ID = nt.NSI_TYPE_ID and n.NSI_OUTCOME_ID = noi.STANDARD_REFERENCE_LIST_ID)
;
insert into R_NSI_TYPE_OUTCOME(NSI_TYPE_ID, NSI_OUTCOME_ID)
...
select nt.NSI_TYPE_ID, noi.STANDARD_REFERENCE_LIST_ID
from R_NSI_TYPE nt, R_STANDARD_REFERENCE_LIST noi join R_REFERENCE_DATA_MASTER rdm on rdm.REFERENCE_DATA_MASTER_ID = noi.REFERENCE_DATA_MASTER_ID
where nt.CODE = 'CRS04' and noi.CODE_VALUE = 'END' and rdm.CODE_SET_NAME = 'NSI OUTCOME'
  and NOT EXISTS
    (select * from R_NSI_TYPE_OUTCOME n where n.NSI_TYPE_ID = nt.NSI_TYPE_ID and n.NSI_OUTCOME_ID = noi.STANDARD_REFERENCE_LIST_ID)
;
...
select nt.NSI_TYPE_ID, noi.STANDARD_REFERENCE_LIST_ID
from R_NSI_TYPE nt, R_STANDARD_REFERENCE_LIST noi join R_REFERENCE_DATA_MASTER rdm on rdm.REFERENCE_DATA_MASTER_ID = noi.REFERENCE_DATA_MASTER_ID
where nt.CODE = 'CRS05' and noi.CODE_VALUE = 'COMP' and rdm.CODE_SET_NAME = 'NSI OUTCOME'
  and NOT EXISTS
    (select * from R_NSI_TYPE_OUTCOME n where n.NSI_TYPE_ID = nt.NSI_TYPE_ID and n.NSI_OUTCOME_ID = noi.STANDARD_REFERENCE_LIST_ID)
;
insert into R_NSI_TYPE_OUTCOME(NSI_TYPE_ID, NSI_OUTCOME_ID)
...
select nt.NSI_TYPE_ID, noi.STANDARD_REFERENCE_LIST_ID
from R_NSI_TYPE nt, R_STANDARD_REFERENCE_LIST noi join R_REFERENCE_DATA_MASTER rdm on rdm.REFERENCE_DATA_MASTER_ID = noi.REFERENCE_DATA_MASTER_ID
where nt.CODE = 'CRS05' and noi.CODE_VALUE = 'END' and rdm.CODE_SET_NAME = 'NSI OUTCOME'
  and NOT EXISTS
    (select * from R_NSI_TYPE_OUTCOME n where n.NSI_TYPE_ID = nt.NSI_TYPE_ID and n.NSI_OUTCOME_ID = noi.STANDARD_REFERENCE_LIST_ID)
;
...
select nt.NSI_TYPE_ID, noi.STANDARD_REFERENCE_LIST_ID
from R_NSI_TYPE nt, R_STANDARD_REFERENCE_LIST noi join R_REFERENCE_DATA_MASTER rdm on rdm.REFERENCE_DATA_MASTER_ID = noi.REFERENCE_DATA_MASTER_ID
where nt.CODE = 'CRS06' and noi.CODE_VALUE = 'COMP' and rdm.CODE_SET_NAME = 'NSI OUTCOME'
  and NOT EXISTS
    (select * from R_NSI_TYPE_OUTCOME n where n.NSI_TYPE_ID = nt.NSI_TYPE_ID and n.NSI_OUTCOME_ID = noi.STANDARD_REFERENCE_LIST_ID)
;
insert into R_NSI_TYPE_OUTCOME(NSI_TYPE_ID, NSI_OUTCOME_ID)
...
select nt.NSI_TYPE_ID, noi.STANDARD_REFERENCE_LIST_ID
from R_NSI_TYPE nt, R_STANDARD_REFERENCE_LIST noi join R_REFERENCE_DATA_MASTER rdm on rdm.REFERENCE_DATA_MASTER_ID = noi.REFERENCE_DATA_MASTER_ID
where nt.CODE = 'CRS06' and noi.CODE_VALUE = 'END' and rdm.CODE_SET_NAME = 'NSI OUTCOME'
  and NOT EXISTS
    (select * from R_NSI_TYPE_OUTCOME n where n.NSI_TYPE_ID = nt.NSI_TYPE_ID and n.NSI_OUTCOME_ID = noi.STANDARD_REFERENCE_LIST_ID)
;
...
select nt.NSI_TYPE_ID, noi.STANDARD_REFERENCE_LIST_ID
from R_NSI_TYPE nt, R_STANDARD_REFERENCE_LIST noi join R_REFERENCE_DATA_MASTER rdm on rdm.REFERENCE_DATA_MASTER_ID = noi.REFERENCE_DATA_MASTER_ID
where nt.CODE = 'CRS07' and noi.CODE_VALUE = 'COMP' and rdm.CODE_SET_NAME = 'NSI OUTCOME'
  and NOT EXISTS
    (select * from R_NSI_TYPE_OUTCOME n where n.NSI_TYPE_ID = nt.NSI_TYPE_ID and n.NSI_OUTCOME_ID = noi.STANDARD_REFERENCE_LIST_ID)
;
insert into R_NSI_TYPE_OUTCOME(NSI_TYPE_ID, NSI_OUTCOME_ID)
...
select nt.NSI_TYPE_ID, noi.STANDARD_REFERENCE_LIST_ID
from R_NSI_TYPE nt, R_STANDARD_REFERENCE_LIST noi join R_REFERENCE_DATA_MASTER rdm on rdm.REFERENCE_DATA_MASTER_ID = noi.REFERENCE_DATA_MASTER_ID
where nt.CODE = 'CRS07' and noi.CODE_VALUE = 'END' and rdm.CODE_SET_NAME = 'NSI OUTCOME'
  and NOT EXISTS
    (select * from R_NSI_TYPE_OUTCOME n where n.NSI_TYPE_ID = nt.NSI_TYPE_ID and n.NSI_OUTCOME_ID = noi.STANDARD_REFERENCE_LIST_ID)
;
